      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold">Aula STEAM</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Transformamos la educación a través de la ciencia, tecnología, ingeniería, artes y matemáticas. 
              Creamos experiencias de aprendizaje innovadoras para el futuro.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Impresión 3D</a></li>
              ...
              <li><a href="#" className="hover:text-white transition-colors">Diseño 3D</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm">
            © 2024 <span className="font-semibold text-white">Aula STEAM</span>. Todos los derechos reservados.
          </div>
